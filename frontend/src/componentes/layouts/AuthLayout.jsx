...
const AuthLayout = ({ children }) => {
  return (
    <div className='flex'>
      <div className='w-screen min-h-screen md:w-[60vw] px-12 pt-8 pb-12 flex gap-[40%] flex-col'>
        <h2 className='text-lg font-medium text-black'>Expense Tracker</h2>
        {children}
      </div>

      <div className='hidden md:block w-[40vw] min-h-screen bg-purple-100 bg-auth-bg-image bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
